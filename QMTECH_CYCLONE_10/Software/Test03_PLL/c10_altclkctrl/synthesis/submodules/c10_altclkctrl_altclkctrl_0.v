...
module  c10_altclkctrl_altclkctrl_0_sub
	( 
	ena,
	inclk,
...
`endif
	...
	assign
		...
		inclk_wire = {inclk},
		outclk = wire_clkctrl1_outclk;
endmodule //c10_altclkctrl_altclkctrl_0_sub
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module  c10_altclkctrl_altclkctrl_0  (
    inclk,
    outclk);
    ...
    c10_altclkctrl_altclkctrl_0_sub  c10_altclkctrl_altclkctrl_0_sub_component (
                .ena (sub_wire1),
                .inclk (sub_wire3),
                .outclk (sub_wire0));
